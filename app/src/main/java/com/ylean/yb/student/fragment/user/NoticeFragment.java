 ...
 */
public class NoticeFragment extends BaseFragment implements MyRefreshLayoutListener, NewsP.Face {
    ...
    protected void initData() {
        ...
        listView.setAdapter(adapter=new NoticeAdapter(activity,listAll));
