...
public class SchoolType extends Dialog implements View.OnClickListener {

    private Activity context;
    private CycleWheelView wheel;
    private List<String> listName=new ArrayList<String>(){{add("高中");add("中职");add("高职");add("大学");}};
    private List<String> listCode=new ArrayList<String>(){{add("0");add("1");add("2");add("3");}};
    ...
    public SchoolType(Activity context, SelectRelationCallBack selectRelationCallBack) {
