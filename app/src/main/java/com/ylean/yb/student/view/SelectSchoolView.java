...
public class SelectSchoolView extends Dialog {

    @BindView(R.id.wheel)
    CycleWheelView wheel;
    private List<SchoolBean.School> list;
    ...
    public SelectSchoolView(Activity context,List<SchoolBean.School> list,TextView textView) {
