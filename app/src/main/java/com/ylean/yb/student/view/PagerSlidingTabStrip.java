...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int selectTabTypefaceStyle=Typeface.NORMAL;
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				if (i == selectedPosition) {
					...
					tab.setTypeface(tabTypeface, selectTabTypefaceStyle);
...
//		canvas.drawRect(lineLeft + (lineRight-lineLeft-indicatorWidth)/2, height - indicatorHeight, lineRight-(lineRight-lineLeft-indicatorWidth)/2, height, rectPaint);
	...
	public void setTypeface(Typeface typeface, int style) {
		...
		this.selectTabTypefaceStyle = style;
		updateTabStyles();
	}
	...
	public void setPageIndex(int pageIndex){
		this.selectedPosition=pageIndex;
	}
